# Generated by Django 5.2.4 on 2025-07-18 20:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='women.category', verbose_name='Категории')),
                ('husband', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='women', to='women.husband', verbose_name='Муж')),
